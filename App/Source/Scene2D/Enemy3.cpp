...
void CEnemy3::Render(void)
{
	...
	glUniformMatrix4fv(transformLoc, 1, GL_FALSE, glm::value_ptr(transform));
	glUniform4fv(colorLoc, 1, glm::value_ptr(rageColour));
...
*/
void CEnemy3::Seti32vec2Index(const int iIndex_XAxis, const int iIndex_YAxis)
{
...
*/
void CEnemy3::Seti32vec2NumMicroSteps(const int iNumMicroSteps_XAxis, const int iNumMicroSteps_YAxis)
{
 ...
 */
void CEnemy3::SetPlayer2D(CPlayer2D* cPlayer2D)
{
...
*/
bool CEnemy3::LoadTexture(const char* filename, GLuint& iTextureID)
{
 ...
 */
void CEnemy3::Constraint(DIRECTION eDirection)
{
	if (eDirection == LEFT)
	{
		if (i32vec2Index.x < 0)
	...
	{
		cout << "CEnemy3::Constraint: Unknown direction." << endl;
	}
}
...
/**
 ...
 @param eDirection A DIRECTION enumerated data type which indicates the direction to check
 */
bool CEnemy3::CheckPosition(DIRECTION eDirection)
{
	if (eDirection == LEFT)
	{
...
// Update Jump or Fall
void CEnemy3::UpdateJumpFall(const double dElapsedTime)
{
 ...
 */
bool CEnemy3::InteractWithPlayer(void)
{
 ...
 */
void CEnemy3::UpdateDirection(void)
{
...
*/
void CEnemy3::UpdatePosition(void)
{
